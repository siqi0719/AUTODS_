...
This business report translates the **_test_smoke.csv** model output into action for **Predict binary target.**. The primary metric **roc_auc** is **0.394**, and the recommended first-wave decisions should use threshold **N/A**.

## 1. Key Findings

- Business goal: Predict binary target..
- Target audience: Data Science Team.
- Primary metric roc_auc: 0.394.
...
- Phase 1 (1-2 weeks): align on goals, thresholds, and review ownership for Predict binary target..
